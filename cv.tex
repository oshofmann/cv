...
1 University Station C0500 & \textit{Web:}
...
\item[] Ph.D., Computer Science, expected 2012
        \begin{innerlist}
        \item Adviser:
...
\item Owen S. Hofmann, Alan Dunn, Sangman Kim, Emmett Witchel.  Ensuring
Operating System Kernel Integrity with OSck.
To appear in \emph{Proceedings of the 16th International Conference on
Architectural
...
\item Scott Wolchok$^\ast$, Owen S. Hofmann$^\ast$,  Nadia Heninger,  Edward W. Felten,
...
\hfill {\footnotesize$^\ast$Both authors contributed equally}
